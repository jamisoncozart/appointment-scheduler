...
function Appointment({ appointment, appointmentIndex, appointmentList, setAppointmentList }) {
  ...
  return (
    <div className="appointment-wrapper">
      ...
      <input
        ...
        onChange={(e) => handleUpdatingAppointment({ ...appointment, date: e.target.value })}
      />
      {/* Time */}
      <input
        className="input"
        ...
        onChange={(e) => handleUpdatingAppointment({ ...appointment, time: e.target.value })}
      />
      {/* Location */}
      <select
        className="select"
